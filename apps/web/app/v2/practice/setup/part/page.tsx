                ...
                {[1, 2, 3].map((part) => (
                  <button
                    ...
                    className={`min-h-12 cursor-pointer rounded-md px-3 text-sm font-semibold transition-colors ${
                      selectedPart === part ? "bg-academic-navy text-white shadow-sm" : "text-slate-600 hover:bg-white"
                    }`}
                  >
                    Part {part}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <label htmlFor="intensity" className="grid gap-2 text-sm font-medium text-slate-700">
                ...
                <input
                  ...
                  className="h-11 cursor-pointer accent-academic-score"
                />
              </label>
            </div>
            ...
            <div className="grid gap-3">
              <div>
                ...
                <h2 className="mt-3 text-xl font-semibold text-slate-950">
                  {profile.title} <span className="text-sm font-medium text-academic-accent">{profile.titleZh}</span>
                </h2>
